...
import com.example.application.entity.ProductSize;
...
import com.example.application.model.dto.PageableDTO;
import com.example.application.model.mapper.ProductMapper;
...
import com.example.application.model.dto.ProductInfoDTO;
import com.example.application.model.dto.ShortProductInfoDTO;
    ...
    public List<ProductInfoDTO> checkPublicPromotion(List<ProductInfoDTO> products) {
        ...
        if (promotion != null) {
            ...
            for (ProductInfoDTO product : products) {
                ...
                if (promotionPrice > 0) {
                    product.setPromotionPrice(Long.valueOf(promotionPrice)); // ép long thành Long
                } else {
                    product.setPromotionPrice(0L); // dùng 0L để thành long -> tự boxing thành Long
                }
